RAID = [
    ...
    "TERI MAA KO KOTHE PE BAITHA KE USKI CHUT MARUNGA 💰 😵🤩",
    "BHOSDIKE TERI MAA KI CHUT MEI 4 HOLE HAI UNME SEAL LAGA BAHUT BAHETI HAI BHOSDIKE👊🤮🤢🤢",
    "TERI BAHEN KI CHUT MEI BARGAD KA PED UGA DUNGAA CORONA MEI SAB OXYGEN LEKAR JAYENGE🤢🤩🥳",
    "TERI MAA KI CHUT MEI SUDO LAGA KE BIGSPAM 9999 DALDUNGA 🤩🥳🔥",
    ...
    "TERI MAA KI BADI BUND ME ZOMATO DAL KE SUBWAY KA BFF VEG SUB COMBO [15cm , 16 inches ] ORDER COD KRVAUNGA OR TERI MAA JAB DILIVERY DENE AYEGI TAB USPE JAADU KRUNGA OR FIR 9 MONTH BAAD VO EK OR FREE DILIVERY DEGI🙀👍🥳🔥",
    "TERI BHEN KI CHUT KAALI MARUNGA LODE KE BAAL🙁🤣💥",
    "TERI MAA KI CHUT ME CHANGES COMMIT KRUGA FIR TERI BHEEN KI CHUT AUTOMATICALLY UPDATE HOJAAYEGI🤖🙏🤔",
    "TERI MAUSI KE BHOSDE MAI INDIAN RAILWAY 🚂💥😂",
    ...
    "TERA BAAP #HYPER 😎😎",
    "TYPE KRNA SIKH LE RANDY KE PAIDAISI",
    "GAREEB KE BIJ APNI MAA KA RATE BTA CHL 😂😂",
    "TERI MAA KO JINDA JALA DUNGA CHINNAL KE BATCHE",
]
...
RRAID = [
    ...
    "MACHAR KI JHAAAAT ",
    "MADRCHOD...",
    "TERI MA KI CHUT MAI AAG LAGADU..",
    "LWDE KE BAAALLL.",
    "TERI MA KI CHUT M DU TAPA TAP?",
    "TERI MA KA BHOSDAA",
    "TERI BHN SBSBE BDI RANDI.",
    "TERI MA SABSE BADI RANDDDDD",
    "TERA BAAP CHKAAAA",
    "KITNI CHODU TERI MA KO AB OR..",
    "TERI MA MARGYI DEKH 😂😂",
    "TERI MA KE STH REELS BNEGA ROAD PEE",
    "TERI MA KI CHUT EK DAM SEXY",
    "MALUM NA PHR KESE LETA HU M TERI MA KI CHUT TAPA TAPPPPP",
    "LUND KE PASINE TU KEREGA TYPING",
    "SPEED PAKAD LWDEEEE",
    "BAAP KI SPEED MATCH KRRR",
    "LWDEEE",
    "PAPA KI SPEED MATCH NHI HO RHI KYA",
    "ALE ALE MELA BCHAAAA",
    "CHUD GYA PAPA SEEE",
    "KISAN KO KHODNA OR HYPER KO CHODNA MT SIKHA",
    "TERI MAA KA RAPE HOGYA DEKH 😂",
    "HAHAHAAAAA",
    "KIDSSSS",
    "TERI MA CHUD GYI AB FRAR MT HONA",
    "YE LADENGE BAPP SE",
    "KIDSSS FRAR HAHAHH",
    "BHEN KE LAWDE SHRM KR",
    "KITNI GALIYA PDWEGA APNI MA KO",
    "NALLEE",
    "SUAR KE PILLE TERI MAAKO SADAK PR LITAKE CHOD DUNGA 😂😆🤤",
    "ABE TERI MAAKA BHOSDA MADERCHOOD KR PILLE PAPA SE LADEGA TU 😼😂🤤",
    "GALI GALI NE SHOR HE TERI MAA RANDI CHOR HE 💋💋💦",
